...
let(:key) { "ssh-rsa AAAAB3NzaC1yc2EAAA0zrqJ1DhN50nny08CvI8blPZTTXb0= test@test" }

describe get_command(:check_user_has_authorized_key, 'foo', key) do
  it { should eq "grep -w '#{key}' ~foo/.ssh/authorized_keys" }
end
